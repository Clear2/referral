...
func (_c *PermissionCreate) SetEnabled(v bool) *PermissionCreate {
	_c.mutation.SetEnabled(v)
	return _c
}

// SetNillableEnabled sets the "enabled" field if the given value is not nil.
func (_c *PermissionCreate) SetNillableEnabled(v *bool) *PermissionCreate {
	if v != nil {
		_c.SetEnabled(*v)
	}
	return _c
...
func (_c *PermissionCreate) SetGroupID(v int) *PermissionCreate {
	_c.mutation.SetGroupID(v)
	return _c
}

// SetNillableGroupID sets the "group_id" field if the given value is not nil.
func (_c *PermissionCreate) SetNillableGroupID(v *int) *PermissionCreate {
	if v != nil {
		_c.SetGroupID(*v)
	}
	return _c
...
func (_c *PermissionCreate) SetGroup(v *PermissionGroup) *PermissionCreate {
	return _c.SetGroupID(v.ID)
}

// AddAPIIDs adds the "apis" edge to the APIResource entity by IDs.
func (_c *PermissionCreate) AddAPIIDs(ids ...int) *PermissionCreate {
	_c.mutation.AddAPIIDs(ids...)
	return _c
}

// AddApis adds the "apis" edges to the APIResource entity.
func (_c *PermissionCreate) AddApis(v ...*APIResource) *PermissionCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *PermissionCreate) AddMenuIDs(ids ...int) *PermissionCreate {
	_c.mutation.AddMenuIDs(ids...)
	return _c
}

// AddMenus adds the "menus" edges to the Menu entity.
func (_c *PermissionCreate) AddMenus(v ...*Menu) *PermissionCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
