...
func (_q *APIResourceQuery) QueryPermissions() *PermissionQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(apiresource.Table, apiresource.FieldID, selector),
...
func (_q *APIResourceQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *APIResourceQuery) FirstIDX(ctx context.Context) int {
...
func (_q *APIResourceQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *APIResourceQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *APIResourceQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *APIResourceQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *APIResourceQuery) WithPermissions(opts ...func(*PermissionQuery)) *APIResourceQuery {
	query := (&PermissionClient{config: _q.config}).Query()
...
func (_q *APIResourceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*APIResource, error) {
	...
	if query := _q.withPermissions; query != nil {
		if err := _q.loadPermissions(ctx, query, nodes,
			func(n *APIResource) { n.Edges.Permissions = []*Permission{} },
			func(n *APIResource, e *Permission) { n.Edges.Permissions = append(n.Edges.Permissions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *APIResourceQuery) loadPermissions(ctx context.Context, query *PermissionQuery, nodes []*APIResource, init func(*APIResource), assign func(*APIResource, *Permission)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*APIResource)
	nids := make(map[int]map[*APIResource]struct{})
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(apiresource.PermissionsTable)
		s.Join(joinT).On(s.C(permission.FieldID), joinT.C(apiresource.PermissionsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(apiresource.PermissionsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(apiresource.PermissionsPrimaryKey[1]))
	...
	qr := QuerierFunc(func(ctx context.Context, q Query) (Value, error) {
		return query.sqlAll(ctx, func(_ context.Context, spec *sqlgraph.QuerySpec) {
			...
			spec.Assign = func(columns []string, values []any) error {
				...
				if nids[inValue] == nil {
					nids[inValue] = map[*APIResource]struct{}{byID[outValue]: {}}
...
func (_q *APIResourceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(apiresource.Table, apiresource.Columns, sqlgraph.NewFieldSpec(apiresource.FieldID, field.TypeInt))
	_spec.From = _q.sql
