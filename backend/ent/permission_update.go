...
func (_u *PermissionUpdate) SetEnabled(v bool) *PermissionUpdate {
	_u.mutation.SetEnabled(v)
	return _u
}

// SetNillableEnabled sets the "enabled" field if the given value is not nil.
func (_u *PermissionUpdate) SetNillableEnabled(v *bool) *PermissionUpdate {
	if v != nil {
		_u.SetEnabled(*v)
	}
	return _u
...
func (_u *PermissionUpdate) SetGroupID(v int) *PermissionUpdate {
	_u.mutation.SetGroupID(v)
	return _u
}

// SetNillableGroupID sets the "group_id" field if the given value is not nil.
func (_u *PermissionUpdate) SetNillableGroupID(v *int) *PermissionUpdate {
	if v != nil {
		_u.SetGroupID(*v)
	}
	return _u
...
func (_u *PermissionUpdate) SetGroup(v *PermissionGroup) *PermissionUpdate {
	return _u.SetGroupID(v.ID)
}

// AddAPIIDs adds the "apis" edge to the APIResource entity by IDs.
func (_u *PermissionUpdate) AddAPIIDs(ids ...int) *PermissionUpdate {
	_u.mutation.AddAPIIDs(ids...)
	return _u
}

// AddApis adds the "apis" edges to the APIResource entity.
func (_u *PermissionUpdate) AddApis(v ...*APIResource) *PermissionUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PermissionUpdate) AddMenuIDs(ids ...int) *PermissionUpdate {
	_u.mutation.AddMenuIDs(ids...)
	return _u
}

// AddMenus adds the "menus" edges to the Menu entity.
func (_u *PermissionUpdate) AddMenus(v ...*Menu) *PermissionUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PermissionUpdate) ClearGroup() *PermissionUpdate {
	_u.mutation.ClearGroup()
	return _u
}

// ClearApis clears all "apis" edges to the APIResource entity.
func (_u *PermissionUpdate) ClearApis() *PermissionUpdate {
	_u.mutation.ClearApis()
	return _u
}

// RemoveAPIIDs removes the "apis" edge to APIResource entities by IDs.
func (_u *PermissionUpdate) RemoveAPIIDs(ids ...int) *PermissionUpdate {
	_u.mutation.RemoveAPIIDs(ids...)
	return _u
}

// RemoveApis removes "apis" edges to APIResource entities.
func (_u *PermissionUpdate) RemoveApis(v ...*APIResource) *PermissionUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PermissionUpdate) ClearMenus() *PermissionUpdate {
	_u.mutation.ClearMenus()
	return _u
}

// RemoveMenuIDs removes the "menus" edge to Menu entities by IDs.
func (_u *PermissionUpdate) RemoveMenuIDs(ids ...int) *PermissionUpdate {
	_u.mutation.RemoveMenuIDs(ids...)
	return _u
}

// RemoveMenus removes "menus" edges to Menu entities.
func (_u *PermissionUpdate) RemoveMenus(v ...*Menu) *PermissionUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PermissionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ApisCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   permission.ApisTable,
			Columns: permission.ApisPrimaryKey,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(apiresource.FieldID, field.TypeInt),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
...
// SetEnabled sets the "enabled" field.
func (_u *PermissionUpdateOne) SetEnabled(v bool) *PermissionUpdateOne {
	_u.mutation.SetEnabled(v)
	return _u
}

// SetNillableEnabled sets the "enabled" field if the given value is not nil.
func (_u *PermissionUpdateOne) SetNillableEnabled(v *bool) *PermissionUpdateOne {
	if v != nil {
		_u.SetEnabled(*v)
	}
	return _u
...
// SetGroupID sets the "group_id" field.
func (_u *PermissionUpdateOne) SetGroupID(v int) *PermissionUpdateOne {
	_u.mutation.SetGroupID(v)
	return _u
}

// SetNillableGroupID sets the "group_id" field if the given value is not nil.
func (_u *PermissionUpdateOne) SetNillableGroupID(v *int) *PermissionUpdateOne {
	if v != nil {
		_u.SetGroupID(*v)
	}
	return _u
...
// SetGroup sets the "group" edge to the PermissionGroup entity.
func (_u *PermissionUpdateOne) SetGroup(v *PermissionGroup) *PermissionUpdateOne {
	return _u.SetGroupID(v.ID)
}

// AddAPIIDs adds the "apis" edge to the APIResource entity by IDs.
func (_u *PermissionUpdateOne) AddAPIIDs(ids ...int) *PermissionUpdateOne {
	_u.mutation.AddAPIIDs(ids...)
	return _u
}

// AddApis adds the "apis" edges to the APIResource entity.
func (_u *PermissionUpdateOne) AddApis(v ...*APIResource) *PermissionUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddMenuIDs adds the "menus" edge to the Menu entity by IDs.
func (_u *PermissionUpdateOne) AddMenuIDs(ids ...int) *PermissionUpdateOne {
	_u.mutation.AddMenuIDs(ids...)
	return _u
}

// AddMenus adds the "menus" edges to the Menu entity.
func (_u *PermissionUpdateOne) AddMenus(v ...*Menu) *PermissionUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearGroup clears the "group" edge to the PermissionGroup entity.
func (_u *PermissionUpdateOne) ClearGroup() *PermissionUpdateOne {
	_u.mutation.ClearGroup()
	return _u
}

// ClearApis clears all "apis" edges to the APIResource entity.
func (_u *PermissionUpdateOne) ClearApis() *PermissionUpdateOne {
	_u.mutation.ClearApis()
	return _u
}

// RemoveAPIIDs removes the "apis" edge to APIResource entities by IDs.
func (_u *PermissionUpdateOne) RemoveAPIIDs(ids ...int) *PermissionUpdateOne {
	_u.mutation.RemoveAPIIDs(ids...)
	return _u
}

// RemoveApis removes "apis" edges to APIResource entities.
func (_u *PermissionUpdateOne) RemoveApis(v ...*APIResource) *PermissionUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearMenus clears all "menus" edges to the Menu entity.
func (_u *PermissionUpdateOne) ClearMenus() *PermissionUpdateOne {
	_u.mutation.ClearMenus()
	return _u
}

// RemoveMenuIDs removes the "menus" edge to Menu entities by IDs.
func (_u *PermissionUpdateOne) RemoveMenuIDs(ids ...int) *PermissionUpdateOne {
	_u.mutation.RemoveMenuIDs(ids...)
	return _u
}

// RemoveMenus removes "menus" edges to Menu entities.
func (_u *PermissionUpdateOne) RemoveMenus(v ...*Menu) *PermissionUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
