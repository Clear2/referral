...
type PermissionEdges struct {
	...
	Apis []*APIResource `json:"apis,omitempty"`
...
// was not loaded in eager-loading.
func (e PermissionEdges) ApisOrErr() ([]*APIResource, error) {
	if e.loadedTypes[2] {
		return e.Apis, nil
	}
...
func (*Permission) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case permission.FieldID, permission.FieldGroupID:
			values[i] = new(sql.NullInt64)
		case permission.FieldName, permission.FieldCode, permission.FieldModule, permission.FieldDescription:
...
func (_m *Permission) QueryGroup() *PermissionGroupQuery {
	return NewPermissionClient(_m.config).QueryGroup(_m)
}

// QueryApis queries the "apis" edge of the Permission entity.
func (_m *Permission) QueryApis() *APIResourceQuery {
	return NewPermissionClient(_m.config).QueryApis(_m)
}

// QueryMenus queries the "menus" edge of the Permission entity.
func (_m *Permission) QueryMenus() *MenuQuery {
	return NewPermissionClient(_m.config).QueryMenus(_m)
}
